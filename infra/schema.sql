...
CREATE INDEX idx_faction_loyalty_user_quest ON faction_loyalty_tracking(user_id, quest_id);
CREATE INDEX idx_user_factions_user_id ON user_factions(user_id);